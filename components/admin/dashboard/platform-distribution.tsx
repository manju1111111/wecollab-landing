...
export function PlatformDistribution({ data: propData, total }: { data?: {name: string, value: number, color: string}[], total?: number }) {
  ...
  return (
    <div className="bg-white rounded-3xl p-6 shadow-sm border border-slate-100 h-[280px] flex flex-col">
      <h3 className="text-[14px] font-bold text-slate-900 mb-2">Platform Distribution</h3>
