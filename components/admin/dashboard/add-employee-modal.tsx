        ...
        {successLink ? (
          ...
          <form onSubmit={handleSubmit} className="p-6 flex flex-col gap-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <select name="role" required className="w-full h-11 pl-10 pr-4 bg-slate-50 border border-slate-200 rounded-xl text-[14px] appearance-none focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all">
            ...
            <div className="mt-4 pt-4 border-t border-slate-100 flex justify-end gap-3">
              ...
              <button type="submit" disabled={isLoading} className="px-5 h-11 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white text-[14px] font-bold shadow-sm shadow-indigo-200 transition-colors disabled:opacity-70 flex items-center gap-2">
