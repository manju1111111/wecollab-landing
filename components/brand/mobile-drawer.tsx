...
import { Menu, X, LogOut, LayoutDashboard, Award, FileText, Settings } from "lucide-react";
...
interface BrandMobileDrawerProps {
  brandName: string;
  initials: string;
  logoutAction: () => Promise<void>;
}

export function BrandMobileDrawer({ brandName, initials, logoutAction }: BrandMobileDrawerProps) {
